...
Product.create!(name:               '爱易分“积分储蓄”年金返还保障计划',
                description:        '3个月内将积分对应的原价返还至客户指定账户，额外赠送全年高额公共轨道交通保障。',
...
redemption = ['00~03个月', '03~06个月', '06~12个月', '全年']
interests  = [0, 0.2, 0.5, 1]

(1..4).each do |n|
  JbzSku.create!(title:             '爱易分“积分储蓄”年金返还保障计划（' + period[n-1] + redemption[n-1] + '）',
